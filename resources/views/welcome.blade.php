...
<head>
  ...
  <style>
    ...
    background-image: url('asset('images/logo.jpg')'); /* Replace with your image path */
    background-size: cover; /* Adjusts the background image to cover the entire div */
...
<body>
  ...
  <div class="container my-5">
    ...
    <!-- Map Image Section -->
    <div class="mapdiv" style="background-image: url('{{ asset('images/logo.jpg') }}');">
    
    <div style="margin-top: 40px;">
      <svg   version="1.2" viewbox="0 0 1000 1745" xmlns="http://www.w3.org/2000/svg">
            <a xlink:title="Kandy" xlink:href="https://www.google.lk/search?source=hp&ei=57w4WvPEKIOe0gTO47CADA&q=Kandy"  >
            ...
            <a xlink:title="Matale" href="https://www.google.lk/search?source=hp&ei=57w4WvPEKIOe0gTO47CADA&q=Matale" >
            ...
            <a xlink:title="Nuwara Eliya"  xlink:href="https://www.google.lk/search?source=hp&ei=57w4WvPEKIOe0gTO47CADA&q=Nuwara Eliya" >
            ...
            <a xlink:title="Ampara" xlink:href="https://www.google.lk/search?source=hp&ei=57w4WvPEKIOe0gTO47CADA&q=Ampara">
            ...
            <a xlink:title="Batticaloa" xlink:href="https://www.google.lk/search?source=hp&ei=57w4WvPEKIOe0gTO47CADA&q=Batticaloa" >
            ...
            <a xlink:title="Polonnaruwa" xlink:href="https://www.google.lk/search?source=hp&ei=57w4WvPEKIOe0gTO47CADA&q=Polonnaruwa">
            ...
            <a xlink:title="Trincomalee" xlink:href="https://www.google.lk/search?source=hp&ei=57w4WvPEKIOe0gTO47CADA&q=Trincomalee" >
            ...
            <a xlink:title="Anuradhapura" xlink:href="https://www.google.lk/search?source=hp&ei=57w4WvPEKIOe0gTO47CADA&q=Anuradhapura">
            ...
            <a xlink:title="Vavuniya" xlink:href="https://www.google.lk/search?source=hp&ei=57w4WvPEKIOe0gTO47CADA&q=Vavuniya">
            ...
            <a xlink:title="Mannar" xlink:href="https://www.google.lk/search?source=hp&ei=57w4WvPEKIOe0gTO47CADA&q=Mannar" >
            ...
            <a xlink:title="Mullativu" xlink:href="https://www.google.lk/search?source=hp&ei=57w4WvPEKIOe0gTO47CADA&q=Mullativu" >
            ...
            <a xlink:title="Jaffna" xlink:href="https://www.google.lk/search?source=hp&ei=57w4WvPEKIOe0gTO47CADA&q=Jaffna" >
            ...
            <a xlink:title="Kilinochchi" xlink:href="https://www.google.lk/search?source=hp&ei=57w4WvPEKIOe0gTO47CADA&q=Kilinochchi" >
            ...
            <a xlink:title="Puttalam" xlink:href="https://www.google.lk/search?source=hp&ei=57w4WvPEKIOe0gTO47CADA&q=Puttalam" >
            ...
            <a xlink:title="Ratnapura" xlink:href="https://www.google.lk/search?source=hp&ei=57w4WvPEKIOe0gTO47CADA&q=Ratnapura">
            ...
            <a xlink:title="Galle" xlink:href="https://www.google.lk/search?source=hp&ei=57w4WvPEKIOe0gTO47CADA&q=Galle" >
            ...
            <a xlink:title="Hambantota" xlink:href="https://www.google.lk/search?source=hp&ei=57w4WvPEKIOe0gTO47CADA&q=Hambantota">
            ...
            <a xlink:title="Matara" href="{{ route('district.divisions', ['id' => 1]) }}" >
            ...
            <a xlink:title="Badulla" href="https://www.google.lk/search?source=hp&ei=57w4WvPEKIOe0gTO47CADA&q=Badulla" >
            ...
            <a xlink:title="Moneragala" xlink:href="https://www.google.lk/search?source=hp&ei=57w4WvPEKIOe0gTO47CADA&q=Moneragala" >
            ...
            <a xlink:title="Kegalle" xlink:href="https://www.google.lk/search?source=hp&ei=57w4WvPEKIOe0gTO47CADA&q=Kegalle">
            ...
            <a xlink:title="Colombo" href="https://www.google.lk/search?source=hp&ei=57w4WvPEKIOe0gTO47CADA&q=Colombo" >
            ...
            <a xlink:title="Gampaha" xlink:href="https://www.google.lk/search?source=hp&ei=57w4WvPEKIOe0gTO47CADA&q=Gampaha" >
            ...
            <a xlink:title="Kalutara" xlink:href="https://www.google.lk/search?source=hp&ei=57w4WvPEKIOe0gTO47CADA&q=Kalutara">
    ...
    <div class="row mb-4" style="margin-bottom: 40px;">
      <div class="col-12 text-center bg-light" style="margin-top: 40px;">
        <h2>District List</h2>
      </div>
      <div class="col-12">
        <div class="district-grid text-center" style="margin-top: 40px;">
          @foreach($districts as $district)
          <div class="district-item">
            <p>{{ $district->name }}</p>
            @if($district->image)
              <img src="{{ asset($district->image) }}" alt="{{ $district->name }} Image" class="img-fluid mb-2">
            @else
              <p>No Image Available</p>
            @endif
            <a href="{{ route('district.divisions', $district->id) }}" class="btn btn-primary">Click Here</a>
          </div>
          @endforeach
        </div>
      </div>
    ...
    <div class="row">
      <div class="col-12">
        <div class="bg-light rounded-corners about-section d-flex flex-column justify-content-center align-items-center text-center" style="margin-top: 40px;">
          <h2>About</h2>
          <p>
            This website shows Sri Lanka 2024 election results. We get most of our news from the official website: 
            <a href="https://elections.gov.lk/indexEn.html" target="_blank">Click here to visit</a>.
          </p>
          <p>
            Our innovative software solutions offer dynamic web development, mobile applications, intuitive design, and data analysis, empowering you to succeed in the ever-evolving digital landscape. <a href="https://www.nbcodezone.online/" target="_blank">Contact Us</a>.
          </p>
        </div>
      </div>
    </div>
